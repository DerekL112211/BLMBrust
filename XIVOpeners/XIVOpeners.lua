...
xivopeners.supportedJobs = {
    ...
    [xivopeners.jobs.BlueMage] = {
        main = xivopeners_blu.main,
        openerInfo = xivopeners_blu.openerInfo,
        queueOpener = xivopeners_blu.queueOpener,
        openerAvailable = xivopeners_blu.openerAvailable,
        checkOpenerIds = xivopeners_blu.checkOpenerIds,
        drawCall = xivopeners_blu.drawCall,
    },
}
